...
import { FallbackFileSystemAdapter } from './FallbackFileSystemAdapter'
import {
  FileNotFoundError,
...
describe('FallbackFileSystemAdapter', () => {
  let fs: FallbackFileSystemAdapter

  beforeEach(() => {
    fs = new FallbackFileSystemAdapter()
  })
  ...
  describe('readFile', () => {
    it('should read a file that exists', async () => {
      await fs.seed({ '/test.txt': 'Hello, World!' })
      const content = await fs.readFile('/test.txt')
      expect(content).toBe('Hello, World!')
    })
  ...
  describe('writeFile', () => {
    it('should create a file in memory', async () => {
  ...
  describe('listDirectory', () => {
    ...
    it('should list directories from nested files', async () => {
      await fs.seed({
  ...
  describe('exists', () => {
    it('should return true for existing file', async () => {
      await fs.seed({ '/test.txt': 'Content' })
      expect(await fs.exists('/test.txt')).toBe(true)
    })
  ...
  describe('mkdir', () => {
    it('should create a directory in memory', async () => {
      const consoleSpy = vi.spyOn(console, 'warn').mockImplementation(() => {})
  ...
  describe('watch', () => {
    it('should return a no-op unwatch function with warning', () => {
      const consoleSpy = vi.spyOn(console, 'warn').mockImplementation(() => {})
  ...
  describe('getRootPath', () => {
    it('should return null when no directory loaded', () => {
      expect(fs.getRootPath()).toBe(null)
    })
  })

  describe('hasFiles', () => {
    it('should return false when empty', () => {
      expect(fs.hasFiles()).toBe(false)
    })

    it('should return true when files exist', async () => {
      await fs.seed({ '/test.txt': 'Content' })
      expect(fs.hasFiles()).toBe(true)
    })
  })
